import type { CellItem } from "../schema/cell";
export const cells: CellItem[] = [
  ...
  },
  {
    ...
    color: "#e879b8",
    modelKind: "ecoli",
    defaultOrganelle: "flagellum",
    comparison: "bacteria",
    renderImage: {
      url: "/cell-renders/ecoli.jpg",
      aspect: "landscape",
    },
    occurrence: {
      title: "Gut, wastewater, labs",
      body: "Escherichia coli is a familiar rod-shaped bacterium: a model organism in genetics and a sentinel species for water safety.",
      motif: "microbe",
    },
    microscope: [
      { label: "Light Microscope", tone: "#f0b8d4", pattern: "bacteria-light" },
      {
        label: "Stained Selection",
        tone: "#e56ba5",
        pattern: "bacteria-stain",
      },
      { label: "Electron Microscope", tone: "#9a9a9c", pattern: "electron" },
    ],
    organelles: [
      {
        id: "cellWall",
        name: "Peptidoglycan wall",
        subtitle: "The rigid rod jacket",
        color: "#c2185b",
        attributes: [
          { label: "Material", value: "Peptidoglycan" },
          { label: "Shape", value: "Rod (bacillus)" },
          { label: "Antibiotics", value: "Target for many drugs" },
        ],
        note: "The cell wall defines the rod shape and resists osmotic pressure; it sits between the plasma membrane and the outer envelope in Gram-negative bacteria.",
        fact: "Losing the wall (e.g., L-forms) changes both shape and antibiotic susceptibility.",
      },
      {
        id: "cellEnvelope",
        name: "Cell envelope",
        subtitle: "Inner membrane + outer membrane",
        color: "#ad1457",
        attributes: [
          { label: "Gram stain", value: "Gram-negative" },
          { label: "Outer membrane", value: "LPS-rich" },
          { label: "Space", value: "Periplasm between layers" },
        ],
        note: "Gram-negative envelopes include an outer membrane with LPS, a thin peptidoglycan layer, and an inner (plasma) membrane enclosing the cytoplasm.",
        fact: "Porins in the outer membrane control entry of small molecules.",
      },
      {
        id: "nucleoid",
        name: "Nucleoid",
        subtitle: "The genomic cluster",
        color: "#8e24aa",
        attributes: [
          { label: "Membrane", value: "None (no nucleus)" },
          { label: "Content", value: "DNA + proteins" },
          { label: "Copies", value: "Often multi-fork during fast growth" },
        ],
        note: "The bacterial chromosome is organized into a nucleoid region without a nuclear envelope; replication and segregation occur in the cytoplasm.",
        fact: "In rapid growth, cells can contain overlapping rounds of replication.",
      },
      {
        id: "flagellum",
        name: "Flagella",
        subtitle: "Long propellers",
        color: "#f8bbd9",
        attributes: [
          { label: "Role", value: "Swimming motility" },
          { label: "Motor", value: "Ion-driven basal body" },
          { label: "Layout", value: "Often several per cell" },
        ],
        note: "Flagella are long helical filaments rotated by motors embedded in the envelope; chemotaxis pathways steer cells toward nutrients.",
        fact: "Some strains are mostly non-motile but remain genetically equipped for flagellar genes.",
      },
      {
        id: "pili",
        name: "Pili & fimbriae",
        subtitle: "Surface hairs",
        color: "#ff80ab",
        attributes: [
          { label: "Length", value: "Shorter than flagella" },
          { label: "Roles", value: "Adhesion, DNA uptake, twitching" },
          { label: "Density", value: "Often numerous" },
        ],
        note: "Thin appendages cover many surfaces; type IV pili can retract for twitching motility, while fimbriae often promote sticking to surfaces.",
        fact: "Pathogenic strains may use specific adhesins (fimbrial tip proteins) to colonize hosts.",
      },
    ],
  },
];
